<!-- GENERATED by ~/.agents/bin/agents-sync @f5dc5e6 hash:998b65c1 — 勿手改；改 ~/.agents/core|hosts|rules -->
<!-- FP:AGENTS-T0-2026Q3 -->
...
[T0-3] MUST NOT force-push main/master；非保護分支只用 --force-with-lease。觸發：git push --force* 且目標為 main|master。例外：無。驗證：hook audit-bash + default.rules 無全域 git 放行。
